...
function NavbarOwner() {
  ...
  return (
    <div className=" shadow-md bg-white fixed w-full z-40">
      <div className="flex flex-wrap py-4 px-5 justify-between items-center lg:px-4 lg:flex-nowrap lg:py-0 w-full container bg ">
        <img
          src={logoNaqos}
        ...
        <div
          ...
          } lg:static lg:drop-shadow-none lg:translate-x-[0%] lg:px-0 lg:bg-inherit lg:text-base lg:justify-end lg:max-w-none lg:block lg:h-fit z-50 `}
        >
          ...
          <div className="flex flex-wrap w-full gap-6 lg:justify-end lg:gap-24 text-slate-800 lg:flex-nowrap lg:items-center">
            ...
            <div className="w-full font-medium text-slate-800 lg:w-fit">Pusat Bantuan</div>
