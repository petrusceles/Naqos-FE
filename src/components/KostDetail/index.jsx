            ...
            <div className="w-auto flex flex-wrap gap-3 justify-center lg:py-4 lg:gap-5">
              <div className="flex flex-wrap justify-center w-full gap-3 pb-2 lg:gap-8 lg:pb-4">
                ...
                <div className="w-full flex justify-center flex-wrap gap-2 lg:gap-4">
                  ...
                  <select
                    name="rent_time"
                    className="text-xs w-[70%] border-2 border-primary rounded px-2 py-[5px] lg:py-2 lg:text-base lg:px-3 select select-sm lg:select-md"
                  >
        ...
        <div className="w-full flex flex-wrap relative gap-3 lg:w-[62%]">
          ...
          <div className="w-full flex flex-wrap gap-3 pb-6 border-b-2 border-slate-200 box-content">
            ...
            <p className="text-xs text-justify">
              ...
              pellentesque magna, gravida accumsan nisi est vitae dolor. Donec
              at lectus sit amet nisi vehicula consequat.
            </p>
          </div>
            ...
            <div className="w-full flex gap-4">
              ...
              <div className="w-full grid grid-cols-1 gap-[5px] items-center">
                ...
                <p className="text-xs text-justify">
                  ...
                  hendrerit, metus nulla pellentesque magna, gravida accumsan
                  nisi est vitae dolor. Donec at lectus sit amet nisi vehicula
                  consequat.
                </p>
              </div>
            </div>
