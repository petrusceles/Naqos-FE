...
function HistoryKostReservationListCard({ booking }) {
        ...
        <div className="flex justify-between w-[70%] gap-2 px-3 rounded-md lg:w-[78%]  lg:h-40 lg:px-6">
          ...
          <div className="flex flex-wrap w-[27%]  text-[10px] justify-end lg:gap-5 gap-2 lg:w-[45%]">
            {booking?.phase == "confirmation" && (
              <>
                <button className="bg-slate-200 box-content py-3 rounded w-full max-w-[180px] self-start text-primary font-semibold hover:scale-105 duration-100 ease-in-out lg:text-base">
                  Tulis Review
                </button>
            ...
            {booking?.phase == "booking" && (
              <>
                <Link
                  to={`/history/reservation/payment?booking_id=${booking._id}`}
                  className="text-center bg-primary box-content lg:py-3 py-1 rounded w-full max-w-[180px] self-start text-slate-50 font-semibold hover:scale-105 duration-100 ease-in-out lg:text-base"
                >
                  Upload Bukti
                </Link>
                <div className="w-full flex self-end justify-end gap-2 text-amber-500 font-medium text-[9px] lg:text-sm items-center">
...
export default HistoryKostReservationListCard;
