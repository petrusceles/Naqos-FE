...
import { useCreateKost } from "../../../queries/kost.js";
function OwnerRoom() {
    ...
    <>
      ...
      <div className="flex gap-4 min-w-[1280px] max-w-[1920px]">
        ...
        <div className="grid grid-cols-1 w-3/4 content-start py-20 px-8 gap-14">
          {/* <div className="fixed h-1/4 w-1/3 bg-slate-50 border-4 border-primary rounded-lg top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 shadow-lg grid max-w-lg max-h-56 place-content-center justify-items-center gap-8 grid-cols-1 p-20">
            <p className="font-bold text-xl ">Apakah data sudah benar?</p>
            <div className="flex w-full  justify-between">
              <button className="font-bold text-slate-100 bg-red-600 py-2 px-4 rounded-lg">
                Belum
              </button>
              <button className="font-bold text-slate-100 bg-primary py-2 px-4 rounded-lg">
                Sudah
              </button>
            </div>
          </div> */}
